...
-- --------------------------------------------------
-- Script has ended - Load Data TEST
-- --------------------------------------------------


INSERT INTO dbo.Doctor (PESEL, ProfessionNo, Name, Surname)
VALUES  ('92122304458', 25458,'DoctorName', 'DoctorSurname');

INSERT INTO dbo.DoctorRecep(ReceiptNumber,ReceiptType,ReceiptCat,IdDoctor)
values (1000000001,'K','L',1);

INSERT INTO dbo.DoctorRecep(ReceiptNumber,ReceiptType,ReceiptCat,IdDoctor)
values (1000000002,'K','L',1);